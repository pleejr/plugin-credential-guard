...
const SECRETS: readonly (readonly [string, string])[] = [
  ...
  ['key after a weak public word and a cue', 'here is the api key for the new account: ' + 'lin_api_' + 'eNN1EnmyLVS8k2wlola2Xs0QblwBmKi6lQVvWCsE'],
  ['announced password with punctuation', 'the password is Summer2026!'],
  ['announced uuid key', 'the api key is a62e3fc3-7812-4fa4-a1d3-73e447a77bb2'],
  ['announced 40-hex key', 'app key: d713a03b26354ab050f57617f49f44dd83063b2b'],
  ['prefix on a hex body', 'shpat_' + '7210ce8397794385781f51b8b1d129c9'],
  ['version-prefixed hex token', 'dop_v1_' + '5bfb192c356eb8cc54403556bd2a239623672edc6ddd2308953268841e33c387'],
  ['self-announced lowercase body', 'acme_api_' + '90ca2m8e2fyeza1ofisoc5hzm3v0uvmv'],
  ['gitlab pat', 'glpat-' + 'jf8M5GSHbbJMjOJ2JWte'],
  ['sendgrid key', 'SG.' + 'J7MeJ49pocOUdaHrTQB3b1' + '.' + '3HaE1NKGjTUoQrWWz0gSgaEvxHVUFyO39fjKWbN1WFS'],
...
const CLEAN: readonly (readonly [string, string])[] = [
  ...
  ['prose about a password', 'the password is stored in 1Password and rotated monthly'],
  ['password attribute name', 'the cluster is created with its own password: `rds_password`'],
  ['account id after a token cue', 'the Sites Read token against account `3a9f0c2e7b1d4e6f8a0b2c4d6e8f0a1b`'],
  ['bare uuid', 'a62e3fc3-7812-4fa4-a1d3-73e447a77bb2'],
  ['commit near a cue', 'the token fix landed in d713a03b26354ab050f57617f49f44dd83063b2b'],
  ['credential id uuid', 'CREDENTIAL_ID=a62e3fc3-7812-4fa4-a1d3-73e447a77bb2'],
  ['prefixed content hash', 'sha256-5bfb192c356eb8cc54403556bd2a239623672edc6ddd2308953268841e33c387'],
  ['snake identifier with api', 'aws_api_gateway_integration_response'],
